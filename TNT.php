    ...
    <main class="main-content">
        <div class="container-custom">
            <div class="content-container">
                <h1 class="content-title">时代少年团</h1>
                <p class="content-subtitle">中国内地男子演唱组合，由七位成员组成</p>
                
                <div class="member-grid">
                    <a href="mjq.php" class="member-btn">
                        <img src="M.jpg" class="member-img" alt="马嘉祺">
                        <h3 class="member-name">马嘉祺</h3>
                        <p class="member-desc">队长、主唱</p>
                    </a>
                    
                    <a href="dcx.php" class="member-btn">
                        <img src="D.jpg" class="member-img" alt="丁程鑫">
                        <h3 class="member-name">丁程鑫</h3>
                        <p class="member-desc">主舞、门面担当</p>
                    </a>
                    
                    <a href="syx.php" class="member-btn">
                        <img src="S.jpg" class="member-img" alt="宋亚轩">
                        <h3 class="member-name">宋亚轩</h3>
                        <p class="member-desc">主唱、忙内</p>
                    </a>
                    
                    <a href="lyw.php" class="member-btn">
                        <img src="L.jpg" class="member-img" alt="刘耀文">
                        <h3 class="member-name">刘耀文</h3>
                        <p class="member-desc">主舞、Rap担当</p>
                    </a>
                    
                    <a href="zhzy.php" class="member-btn">
                        <img src="Z.jpg" class="member-img" alt="张真源">
                        <h3 class="member-name">张真源</h3>
                        <p class="member-desc">主唱、综艺担当</p>
                    </a>
                    
                    <a href="yhx.php" class="member-btn">
                        <img src="Y.jpg" class="member-img" alt="严浩翔">
                        <h3 class="member-name">严浩翔</h3>
                        <p class="member-desc">Rap担当</p>
                    </a>
                    
                    <a href="hjl.php" class="member-btn">
                        <img src="H.jpg" class="member-img" alt="贺峻霖">
                        <h3 class="member-name">贺峻霖</h3>
                        <p class="member-desc">主持、舞蹈担当</p>
                    </a>
                </div>
                ...
                <div class="content-container" style="margin-top: 40px; background-color: var(--primary-extra-light);">
                    ...
                    <p style="line-height: 1.8; color: var(--secondary-color);">
                        时代少年团（Teens in Times，简称TNT）是中国内地男子演唱组合，由时代峰峻推出，由马嘉祺、丁程鑫、宋亚轩、刘耀文、张真源、严浩翔、贺峻霖七人组成。
                        2019年11月23日，时代少年团组合举行出道暨新歌首唱会，正式以时代少年团的身份出道，并发行单曲《无尽的冒险》。
                    </p>
                </div>
            </div>
        </div>
