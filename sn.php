    ...
    <main class="main-content">
        <div class="container-custom">
            <div class="content-container">
                <h1 class="content-title">登陆少年</h1>
                <p class="content-subtitle">TF家族四代练习生培养计划，新生代偶像的摇篮</p>
                
                <div class="member-grid">
                    <a href="zh.php" class="member-btn">
                        <img src="zuo.jpg" class="member-img" alt="左航">
                        <div>
                    ...
                    <a href="zzy.php" class="member-btn">
                        <img src="zack.jpg" class="member-img" alt="张泽禹">
                        <div>
                    ...
                    <a href="zzx.php" class="member-btn">
                        <img src="22.jpg" class="member-img" alt="朱志鑫">
                        <div>
                    ...
                    <a href="zj.php" class="member-btn">
                        <img src="jeremy.jpg" class="member-img" alt="张极">
                        <div>
                    ...
                    <a href="sxh.php" class="member-btn">
                        <img src="su.jpg" class="member-img" alt="苏新皓">
                        <div>
                ...
                <div class="content-container" style="margin-top: 40px; background-color: var(--primary-extra-light);">
                    ...
                    <p style="line-height: 1.8; color: var(--secondary-color);">
                        登陆少年是TF家族四代练习生培养计划，专注于发掘和培养有潜力的青少年，为他们提供专业的艺术培训。
                        该计划致力于打造新生代偶像团体，通过系统培训和专业指导，为年轻练习生提供全方位的成长平台，
                        涵盖声乐、舞蹈、表演等多方面，为未来的演艺事业奠定坚实基础。
                    </p>
                </div>
            </div>
        </div>
